...
var S = class {
	...
	static computeMateTransform(t, n, r, i, a = .5) {
		...
		let c = new S(o.worldPosition, o.worldDirection, o.worldUp), l = c.direction.clone().negate().normalize(), u = c.up.clone().normalize(), d = new e.Vector3().crossVectors(u, l).normalize(), f = new e.Vector3().crossVectors(l, d).normalize(), p = new e.Matrix4();
		p.makeBasis(d, f, l);
		let m = new S(s.localPosition, s.localDirection, s.localUp), h = new e.Matrix4();
		...
		}, C = m.position.clone().applyQuaternion(v).add(b), w = m.direction.clone().applyQuaternion(v).normalize(), T = C.distanceTo(c.position), E = w.dot(c.direction), D = T <= a && E <= -.99;
		return {
			success: D,
			placement: x,
			positionErrorMm: T,
...
var D = class {
	...
	static testCaseA() {
		let e = g.get("TRAY_STRAIGHT"), t = g.get("FITTING_ELBOW_90"), n = new s("inst_straight", e, {
			...
			width: 600,
			depth: 100
		}), i = w.validateConnection(n, "PORT_B", r, "PORT_A"), a = i.valid && i.code === "OK";
		return {
			id: "Case A",
	...
	static testCaseB() {
		let e = g.get("TRAY_STRAIGHT"), t = g.get("FITTING_ELBOW_90"), n = new s("inst_straight", e, {
			...
			width: 450,
			depth: 100
		}), i = w.validateConnection(n, "PORT_B", r, "PORT_A"), a = !i.valid && (i.code === "WIDTH_MISMATCH" || i.code === "DIMENSION_MISMATCH");
		return {
			id: "Case B",
	...
	static testCaseC() {
		let e = g.get("TRAY_STRAIGHT"), t = g.get("FITTING_ELBOW_90"), n = new s("inst_straight", e, {
			...
			width: 600,
			depth: 150
		}), i = w.validateConnection(n, "PORT_B", r, "PORT_A"), a = !i.valid && (i.code === "DEPTH_MISMATCH" || i.code === "DIMENSION_MISMATCH");
		return {
			id: "Case C",
	...
	static testCaseD() {
		let e = g.get("TRAY_STRAIGHT"), t = g.get("EQUIP_JUNCTION_BOX"), n = new s("inst_straight", e), r = new s("inst_jb", t), i = w.validateConnection(n, "PORT_B", r, "PORT_BOTTOM_GLAND"), a = !i.valid && i.code === "TYPE_MISMATCH";
		return {
			id: "Case D",
	...
	static testCaseE() {
		let e = g.get("TRAY_STRAIGHT"), t = g.get("TRAY_STRAIGHT"), n = g.get("FITTING_REDUCER_LEFT"), r = new s("s600", e, {
			...
			width: 450,
			depth: 100
		}), o = w.validateConnection(r, "PORT_B", i, "PORT_A"), c = w.validateConnection(i, "PORT_B", a, "PORT_A"), l = o.valid && c.valid;
		return {
			id: "Case E",
	...
	static testCaseF() {
		let e = g.get("TRAY_STRAIGHT"), t = new s("instA", e, { length: 3e3 }), n = new s("instB", e, { length: 3e3 }), r = C.computePlacement(t, "PORT_B", n, "PORT_A");
		n.setPlacement(r);
	...
	static testCaseG() {
		...
		for (let n = 1; n < 10; n++) {
			let r = t[n - 1], i = new s(`tray_${n}`, e, { length: 3e3 }), a = C.computePlacement(r, "PORT_B", i, "PORT_A");
	...
	static testCaseH() {
		let e = g.get("FITTING_ELBOW_90"), t = D.exportDefinition(e), n = t.schemaVersion === "2.0.0", r = t.ports.length === 2, i = t.centerlines.length === 1, a = !!t.bounds && t.bounds.min && t.bounds.max, o = n && r && i && a;
		return {
			id: "Case H",
	...
	static testCaseI() {
		...
		n.setPlacement(C.computePlacement(t, "PORT_B", n, "PORT_A")), r.setPlacement(C.computePlacement(n, "PORT_B", r, "PORT_A")), i.setPlacement(C.computePlacement(r, "PORT_B", i, "PORT_A"));
	...
	static testCaseR_BoundsConsistency() {
		...
		e.forEach((e) => {
			...
			let a = i.getBounds(i.defaultParameters), o = E(i, i.defaultParameters), s = o.min, c = o.max, l = [
				"X",
				"Y",
				"Z"
			];
	...
	static testCaseS_PortFrameHandedness() {
		...
		e.forEach((e) => {
			e.getLocalPorts(e.defaultParameters).forEach((a) => {
				t++;
				let o = new S(a.localPosition, a.localDirection, a.localUp).getDeterminant();
	...
	static testCaseV_DerivedStateExport() {
		let e = new s("test_export_inst", g.get("TRAY_STRAIGHT")), t = D.exportScene([e]).instances[0], n = !!t.derivedSnapshot, r = t.derivedSnapshot?.status === "NON_CANONICAL_SNAPSHOT", i = !!t.effectiveParameters && !!t.placement, a = n && r && i;
		return {
			id: "Case V",
	...
	static testCaseW_CatalogProfileA() {
		...
		let r = x("FITTING_TEE", e), i = t.effectiveParameters.width === 100, a = t.effectiveParameters.depth === 50, s = n.effectiveParameters.width === 100, c = n.effectiveParameters.depth === 50, l = n.effectiveParameters.radius === 300, u = n.effectiveParameters.tangentLength === 125, d = r.effectiveParameters.width === 100, f = r.effectiveParameters.depth === 50, p = w.validateConnection(t, "PORT_B", n, "PORT_A"), m = C.computePlacement(t, "PORT_B", n, "PORT_A");
		n.setPlacement(m);
...
//#endregion
export { k as AcceptanceTestSuite, c as AnalyticLength, v as AssemblyRegistry, t as AssumptionLevel, T as BomManager, n as BomScope, _ as CatalogStandards, s as ComponentInstance, r as ComponentOrigin, g as ComponentRegistry, i as ComponentRole, w as ConnectionValidator, d as GeometryGenerators, D as JsonExporter, O as LEGACY_FITTING_BASELINES, C as MateEngine, u as Materials, l as RouteGenerator, o as Transforms, b as TraySystemProfiles, a as Units, y as VENDOR_PROFILES, A as VERSION, E as computeGeometryBounds, x as createComponentFromProfile };
