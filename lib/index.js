...
var z = class {
	...
	static initAll() {
		...
		}), this.register(Pe("FITTING_ELBOW_90", 90, r.LEGACY_FITTING_LIBRARY, "PDF p.5 / p.31 / p.42")), this.register(Fe()), this.register(R("FITTING_RISER_IN_90", 90, !1, r.LEGACY_FITTING_LIBRARY, "PDF p.11 / p.34 / p.44")), this.register(R("FITTING_RISER_OUT_90", 90, !0, r.LEGACY_FITTING_LIBRARY, "PDF p.15 / p.35 / p.45")), this.register({
			schemaVersion: "2.0.0",
			componentVersion: "1.0.0",
		...
		}), this.register(Pe("FITTING_ELBOW_45", 45, r.NEW_COMPONENT, "PDF p.7 / p.32")), this.register(Pe("FITTING_ELBOW_60", 60, r.NEW_COMPONENT, "PDF p.6")), this.register(Pe("FITTING_ELBOW_30", 30, r.NEW_COMPONENT, "PDF p.8 / p.43")), this.register(R("FITTING_RISER_IN_45", 45, !1, r.NEW_COMPONENT, "PDF p.13")), this.register(R("FITTING_RISER_IN_60", 60, !1, r.NEW_COMPONENT, "PDF p.12")), this.register(R("FITTING_RISER_IN_30", 30, !1, r.NEW_COMPONENT, "PDF p.14")), this.register(R("FITTING_RISER_OUT_45", 45, !0, r.NEW_COMPONENT, "PDF p.17")), this.register(R("FITTING_RISER_OUT_60", 60, !0, r.NEW_COMPONENT, "PDF p.16")), this.register(R("FITTING_RISER_OUT_30", 30, !0, r.NEW_COMPONENT, "PDF p.18")), this.register(Le("FITTING_REDUCER_LEFT", "LEFT", {
			name: "Left Reducer",
			nameZh: "左偏異徑接頭",
			page: "PDF p.20"
		})), this.register(Le("FITTING_REDUCER_CENTER", "CONCENTRIC", {
			name: "Center Reducer",
			nameZh: "中間異徑接頭",
			page: "PDF p.19"
		})), this.register(Le("FITTING_REDUCER_RIGHT", "RIGHT", {
			name: "Right Reducer",
			nameZh: "右偏異徑接頭",
			page: "PDF p.21"
		})), this.register(Ie()), this.register({
			schemaVersion: "2.0.0",
			componentVersion: "1.0.0",
			id: "STRUCT_MAIN_BAY",
...
var Ve = "R = inner radius of the bend (inner side rail for horizontal bends / tee / cross; rail-top side for vertical inside bends; tray bottom for vertical outside bends). Routing centerline radius = R + W/2 (horizontal) or R + H/2 (vertical).", He = [
	100,
	200,
	300,
	400,
	...
	900,
	1e3
], Ue = "Polyester powder coating #67 light grey, ≥ 50 µm", We = {
...
function V(e, t, n = {}) {
	...
	switch (t.lipWidthMm && (r.lipWidth = t.lipWidthMm), Ge(e)) {
		case "STRAIGHT":
		...
		case "REDUCER": {
			...
			r.inletWidth = e, r.outletWidth = Ke(t, e), r.length = t.reducerLength || 600, r.tangentLength = t.reducerTangentLength || 200;
			break;
		}
	}
	return {
...
function H(e, t, n = {}, r) {
	...
	return new s(r || `${e.toLowerCase()}_${Date.now()}_${Math.floor(Math.random() * 1e3)}`, i, V(e, t, n));
}
//#endregion
...
function Xe(e) {
	...
	let t = [];
	return Object.values(qe).forEach((n) => {
		let r = n.profileId ? We[n.profileId] : void 0;
...
var Ze = class {
	...
	static computeMateTransform(t, n, r, i, a = .5) {
		...
		let c = new Ze(o.worldPosition, o.worldDirection, o.worldUp), l = c.direction.clone().negate().normalize(), u = c.up.clone().normalize(), d = new e.Vector3().crossVectors(u, l).normalize(), f = new e.Vector3().crossVectors(l, d).normalize(), p = new e.Matrix4();
		p.makeBasis(d, f, l);
		let m = new Ze(s.localPosition, s.localDirection, s.localUp), h = new e.Matrix4();
	...
	static createHorizontalElbow(e, t, n, r, i = 20, a = 0) {
		...
		return {
			...
			toPort: t,
			type: "ARC_XZ",
			analyticLength: a > 0 ? W.arcWithTangents(n, r, a) : W.circularArc(n, r),
			samplePoints: s
		};
	}
	...
	static createVerticalRiser(e, t, n, r, i = !1, a = 20) {
		...
		return {
			...
			toPort: t,
			type: "ARC_XY",
			analyticLength: W.circularArc(n, r),
			samplePoints: s
		};
	}
...
var K = class {
	static checkJoint(e, t, n, r, i = {}) {
		let a = i.positionMm ?? .01, s = i.planeMm ?? .05, c = i.faceMm ?? .05, l = i.dot ?? 1e-6, u = [], d = G.validateConnection(e, t, n, r), f = e.getWorldPorts().find((e) => e.id === t), p = n.getWorldPorts().find((e) => e.id === r), m = {
		...
		if (!f || !p) return m;
		let h = et(f), g = et(p), _ = h.origin.distanceTo(g.origin), v = h.normal.dot(g.normal), y = h.up.dot(g.up), b = tt($e(e), h, h, s, 1), x = tt($e(n), h, h, s, -1), S = 0, C = f.connectionFace, w = (e, t) => {
			if (!e) {
		...
		let T = nt(e, t), E = nt(n, r), D = T && E ? o.distance(T, E) : Infinity;
	...
	static checkPortTermination(e, t = {}) {
		let n = t.planeMm ?? .05, r = t.faceMm ?? .05, i = $e(e);
		return e.getWorldPorts().filter((e) => e.connectionType === "TRAY_END").map((e) => {
			let t = et(e), a = tt(i, t, t, n), o = Infinity;
...
function rt(e, t = {}) {
	...
	return e.forEach((e, a) => {
		let o = z.get(e.definitionId);
		if (!o) throw Error(`Unknown component '${e.definitionId}'`);
		let c = t.profile ? V(e.definitionId, t.profile, e.overrides ?? {}) : { ...e.overrides ?? {} }, l = new s(e.instanceId ?? `asm_${a}_${e.definitionId.toLowerCase()}`, o, c);
		if (a === 0) {
			t.basePlacement && l.setPlacement(t.basePlacement), n.push(l);
			return;
		}
		let u = e.attachTo ?? a - 1, d = n[u], f = e.attachPort ?? "PORT_B", p = e.port ?? "PORT_A", m = U.placeComponentByPort(d, f, l, p);
		m.success || i.push(`Step ${a} (${e.definitionId}): ${m.message}`), n.push(l);
		let h = K.checkJoint(d, f, l, p);
...
var it = {
	...
	static generateBom(e, t = {}) {
		...
		e.forEach((e) => {
			(ze.isAssembly(e.definitionId) || e.definition.subComponents && e.definition.subComponents.length > 0) && (c.add(e.instanceId), (ze.getSubComponents(e.definitionId).length > 0 ? ze.getSubComponents(e.definitionId) : e.definition.subComponents || []).forEach((t) => {
		...
		e.forEach((e) => {
			...
			let g = ze.isAssembly(t.id) || t.subComponents && t.subComponents.length > 0 || !1, _ = `${t.id}|${f}`;
...
function ut(e) {
	return l.normalize(l.cross(lt, e));
}
//#endregion
...
var ft = (t) => new e.Vector3(t[0], t[1], t[2]), pt = (e) => [
	e.x,
	e.y,
	e.z
];
function mt(e, t) {
	return pt(ft(t).applyQuaternion(e));
}
function ht(t, n, r, i) {
	let a = (e, t) => {
	...
	if (!o || !s) return null;
	let c = new e.Matrix4().makeBasis(ft(o[0]), ft(o[1]), ft(o[2])), u = new e.Matrix4().makeBasis(ft(s[0]), ft(s[1]), ft(s[2])).multiply(c.transpose());
...
function _t(e) {
	if (Math.abs(e[1]) < 1e-6) return lt;
...
function xt(e, t, n, r, i) {
	...
	if (t.length === 2) {
		...
		if (i.level && a.level) {
			let t = bt(u, n.allowedHorizontalAngles, r.deg);
		...
		if (i.level !== a.level) {
			...
			let f = bt(u, n.allowedVerticalAngles, r.deg);
...
function St(e, t, n, r, i, a, o) {
	...
	for (let t of d(a)) {
		...
		if (a < 0) continue;
		let d = u.get(i[a]), f = ht(d.localDirection, d.localUp, t[a].dir, lt);
		if (!f || !i.every((e, n) => {
			let r = u.get(e);
			return l.dot(mt(f, r.localDirection), t[n].dir) < o.cos ? !1 : !t[n].level || l.dot(mt(f, r.localUp), lt) > o.cos;
		})) continue;
		let p = null;
		for (let e = 0; e < i.length && !p; e++) for (let t = e + 1; t < i.length && !p; t++) {
			let n = u.get(i[e]), r = u.get(i[t]);
			p = gt(n.localPosition, n.localDirection, r.localPosition, r.localDirection);
		}
		if (p) return {
			instance: new s(e, c, n, vt(f, l.sub(r, mt(f, p)))),
...
function Ct(e, t, n, r, i, a) {
	let o = z.get(t);
	if (!o) return null;
	let c = o.getLocalPorts(n).find((e) => e.id === "PORT_A"), u = ht(c.localDirection, c.localUp, l.scale(i, -1), a);
	return u ? new s(e, o, n, vt(u, l.sub(r, mt(u, c.localPosition)))) : null;
}
function wt(e, t) {
...
function Et(e, t, n = {}) {
	let r = Tt(n), i = n.idPrefix ?? "net:", a = yt(e, r.sin), c = [...a.issues], u = [], d = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map();
	...
	let p = (e, n) => B.supports(t, e) ? !0 : (c.push({
		severity: "ERROR",
		code: "FITTING_NOT_OFFERED",
		nodeId: n,
		message: `${e} needed at ${n} is not offered in ${t.name}.`,
		values: { definitionId: e }
	}), !1), m = (e, n) => V(e, t, n), h = (e, t, n, r, a) => {
		if (n.segment.width >= t || !p("FITTING_REDUCER_CENTER", e)) return;
		let o = `${i}${e}:${n.segment.id}:REDUCER`, s = Ct(o, "FITTING_REDUCER_CENTER", m("FITTING_REDUCER_CENTER", {
			inletWidth: t,
			outletWidth: n.segment.width
		}), r, n.dir, a);
		if (s) return u.push({
			id: o,
			nodeId: e,
	...
	for (let [e, n] of a.legs) {
		let o = a.nodes.get(e), s = xt(e, n, t, r, c);
		if (f.set(e, s), s.kind !== "FITTING" || !p(s.definitionId, e)) continue;
		let l = `${i}${e}:${s.definitionId}`, _ = St(l, s.definitionId, m(s.definitionId, { width: s.width }), o.position, s.ports, s.legs, r);
		if (!_) {
			c.push({
				severity: "ERROR",
		...
		u.push({
			...
			instance: _.instance,
			legs: [..._.portLegs].map(([e, t]) => ({
				segmentId: t.segment.id,
				portId: e
			}))
		});
		for (let [t, n] of _.portLegs) {
			let r = wt(_.instance, t), i = h(e, s.width, n, r.worldPosition, r.worldUp), a = i ? g(o.position, n, wt(u[u.length - 1].instance, "PORT_B").worldPosition, e, "Reducer") : g(o.position, n, r.worldPosition, e, s.definitionId);
			d.set(J(n.segment.id, e), {
				nodeId: e,
				segmentId: n.segment.id,
				reachMm: a,
				up: r.worldUp,
	...
	let _ = new Map(e.segments.map((e) => [e.id, e.id])), v = (e) => _.get(e) === e ? e : (_.set(e, v(_.get(e))), _.get(e));
	for (let [e, t] of f) {
		if (t.kind !== "PASS" && t.kind !== "INLINE_REDUCER") continue;
		let [n, r] = a.legs.get(e);
		_.set(v(n.segment.id), v(r.segment.id));
	}
	let y = /* @__PURE__ */ new Map();
	for (let e of d.values()) {
		if (!e.up) continue;
		let t = v(e.segmentId), n = y.get(t);
	...
	let b = (e) => l.normalize(l.sub(a.nodes.get(e.to).position, a.nodes.get(e.from).position)), x = (e) => y.get(v(e.id)) ?? _t(b(e));
	for (let [e, t] of f) {
		let n = a.nodes.get(e);
		if (t.kind === "INLINE_REDUCER") {
			d.set(J(t.wide.segment.id, e), {
				nodeId: e,
				segmentId: t.wide.segment.id,
				reachMm: 0,
				up: null
			});
			let r = h(e, t.wide.segment.width, t.narrow, n.position, x(t.narrow.segment)), i = r ? g(n.position, t.narrow, wt(u[u.length - 1].instance, "PORT_B").worldPosition, e, "Reducer") : 0;
			d.set(J(t.narrow.segment.id, e), {
				nodeId: e,
		...
		for (let t of a.legs.get(e)) d.has(J(t.segment.id, e)) || d.set(J(t.segment.id, e), {
			nodeId: e,
			segmentId: t.segment.id,
			reachMm: 0,
			up: null
	...
	let S = [], C = z.get("TRAY_STRAIGHT");
	for (let t of e.segments) {
		let e = a.nodes.get(t.from), n = a.nodes.get(t.to), r = d.get(J(t.id, t.from)), o = d.get(J(t.id, t.to));
		if (!e || !n || !r || !o) continue;
		...
		if (h <= .5) continue;
		let g = l.add(e.position, l.scale(p, r.reachMm)), _ = l.sub(n.position, l.scale(p, o.reachMm)), v = x(t), y = ht([
			0,
			0,
			1
		], [
			...
			1,
			0
		], p, v), b = `${i}${t.id}:STRAIGHT`, w = new s(b, C, m("TRAY_STRAIGHT", {
			width: t.width,
			length: h
		}), vt(y, l.scale(l.add(g, _), .5)));
		S.push({
			id: b,
			segmentId: t.id,
			start: g,
	...
	let w = !c.some((e) => e.severity === "ERROR"), T = Object.fromEntries(d), E = new Map(u.map((e) => [e.id, e])), D = new Map(S.map((e) => [e.segmentId, e])), O = new Map(e.segments.map((e) => [e.id, e])), k = (e, t, n) => E.get(e)?.instance.getCenterlines().find((e) => e.fromPort === t && e.toPort === n || e.fromPort === n && e.toPort === t)?.analyticLength, A = (e) => e?.reducer ? k(e.reducer.id, "PORT_A", "PORT_B") ?? 0 : 0, ee = (e) => {
		let t = {
			lengthMm: 0,
			polylineMm: 0,
			ok: !0,
		...
		r.forEach((e, o) => {
			...
			let f = D.get(e.id);
			if (t.lengthMm += f ? f.lengthMm : 0, !f && (d.get(J(e.id, e.from))?.reachMm ?? 0) + (d.get(J(e.id, e.to))?.reachMm ?? 0) > l.length(l.sub(u, c)) + .5 && n(`Segment ${e.id} is too short for its fittings.`), o < r.length - 1) {
				let i = d.get(J(e.id, s)), a = d.get(J(r[o + 1].id, s));
				if (t.lengthMm += A(i) + A(a), i?.fitting && a?.fitting && i.fitting.id === a.fitting.id) {
					let e = k(i.fitting.id, i.fitting.portId, a.fitting.portId);
	...
	return {
		...
		issues: c,
		ok: w,
		instances: () => [...u.map((e) => e.instance), ...S.map((e) => e.instance)],
		pathCenterline: ee,
		pathPoints: (e) => {
			...
			let i = r.length > 1 && ((e, t) => [e.from, e.to].find((e) => e === t.from || e === t.to))(r[0], r[1]) === r[0].from ? r[0].to : r[0].from;
			for (let e = 0; e < r.length; e++) {
				let t = r[e], a = t.from === i ? t.to : t.to === i ? t.from : void 0;
				if (!a) break;
				let o = D.get(t.id);
				if (o && n(te(o.instance, t.from === i ? "PORT_A" : "PORT_B", t.from === i ? "PORT_B" : "PORT_A")), e < r.length - 1) {
					let i = d.get(J(t.id, a)), o = d.get(J(r[e + 1].id, a));
					i?.reducer && n(te(E.get(i.reducer.id).instance, "PORT_B", "PORT_A")), i?.fitting && o?.fitting && i.fitting.id === o.fitting.id && n(te(E.get(i.fitting.id).instance, i.fitting.portId, o.fitting.portId)), o?.reducer && n(te(E.get(o.reducer.id).instance, "PORT_A", "PORT_B"));
				}
				i = a;
			}
			return t;
		...
		bom: () => {
			let n = at.generateBom(u.map((e) => e.instance)).items, r = new Map(e.segments.map((e) => [e.id, e.id])), i = (e) => r.get(e) === e ? e : (r.set(e, i(r.get(e))), r.get(e));
			for (let [e, t] of f) {
			...
			for (let e of S) {
				let n = O.get(e.segmentId), r = i(n.id), a = o.get(r) ?? {
					width: n.width,
...
function Dt(e, t, n, r, i) {
	...
	return (o.segmentEnds[J("s", "N")]?.reachMm ?? 0) + (o.segmentEnds[J("s", "S")]?.reachMm ?? 0);
}
function Ot(e, t, n) {
...
function kt(e, t, n = {}) {
	let r = Tt(n), i = [], a = [], o = e.nodes.map((e) => ({
		id: e.id,
		position: [...e.position]
	...
	for (let [e, c] of u.legs) {
		...
		let _ = Math.max(f[0].segment.width, f[1].segment.width), v = p.dir[1] > 0, y = Dt(t, _, p.segment.width, v, n), b = l.normalize(l.cross(lt, l.scale(f[0].dir, -1))), x = u.nodes.get(p.otherId), S = (t) => {
			let n = l.scale(b, t * y), r = l.add(m.position, n), i = l.add(x.position, n), a = Infinity;
			for (let t of s) {
			...
			return a;
		}, C = n.verticalTeeSide?.(e) ?? (S(1) >= S(-1) ? 1 : -1), w = l.scale(b, C * y), T = `${d}${e}~VT`, E = `${d}${p.segment.id}~STUB`, D = l.clean(l.add(m.position, w));
		o.push({
			id: T,
			position: D
		});
		let O = o.find((e) => e.id === x.id), k = l.clean(l.add(x.position, w)), A = s.find((e) => e.id === p.segment.id), ee = {
			from: A.from,
			to: A.to
		};
		A.from === e ? A.from = T : A.to = T, s.push({
			id: E,
			from: e,
			to: T,
			width: A.width,
			...
			to: T,
			width: A.width,
			reason: `Horizontal stub from the tee branch to the vertical bend (${(y / 1e3).toFixed(3)} m).`
		}), i.push({
			...
			nodeId: e,
			segmentId: A.id,
			message: `Vertical tee at ${e} replaced by a level tee, a ${(y / 1e3).toFixed(3)} m stub and a vertical bend; ${x.id} moves ${(y / 1e3).toFixed(3)} m sideways.`,
			values: {
				stubMm: +y.toFixed(1),
				side: C
			}
...
], Z = () => B.get("LADDER_PROFILE_STANDARD"), Pt = () => B.get("VENTILATED_PROFILE_A"), Ft = () => B.get("VENTILATED_PROFILE_B");
function Q(e, t) {
	return Math.hypot(e[0] - t[0], e[1] - t[1], e[2] - t[2]);
}
function It(e, t) {
...
function zt() {
	...
	], ct.PAGE_Y_DOWN_METRES);
}
function Bt() {
	return Et(kt(zt(), Z()).network, Z());
}
function Vt(e, t, n) {
	let r = e.getCenterlines().find((e) => e.fromPort === t && e.toPort === n || e.fromPort === n && e.toPort === t);
...
function Ht() {
	return z.getAll().filter((e) => Ge(e.id) !== "OTHER");
}
function Ut(e) {
	let t = [{
		label: "GENERIC",
	...
	return B.getAll().forEach((n) => {
		B.supports(n, e.id) && t.push({
			label: n.id,
			params: {
				...e.defaultParameters,
				...V(e.id, n)
...
var Wt = class {
	...
	static testCaseA() {
		let e = H("TRAY_STRAIGHT", Z(), {}, "inst_straight"), t = H("FITTING_ELBOW_90", Z(), {}, "inst_elbow"), n = G.validateConnection(e, "PORT_B", t, "PORT_A");
	...
	static testCaseB() {
		let e = new s("inst_straight", z.get("TRAY_STRAIGHT"), {
			width: 600,
			depth: 100
		}), t = new s("inst_elbow", z.get("FITTING_ELBOW_90"), {
			width: 450,
			depth: 100
		}), n = G.validateConnection(e, "PORT_B", t, "PORT_A");
	...
	static testCaseD() {
		let e = new s("inst_straight", z.get("TRAY_STRAIGHT")), t = new s("inst_jb", z.get("EQUIP_JUNCTION_BOX")), n = G.validateConnection(e, "PORT_B", t, "PORT_BOTTOM_GLAND"), r = new s("l", z.get("TRAY_STRAIGHT"), {
			width: 300,
			depth: 100,
			trayStyle: "LADDER"
		}), i = new s("v", z.get("FITTING_ELBOW_90"), {
			width: 300,
			depth: 100,
			trayStyle: "VENTILATED_THROUGH"
		}), a = G.validateConnection(r, "PORT_B", i, "PORT_A");
	...
	static testCaseE() {
		let e = H("TRAY_STRAIGHT", Z(), { width: 600 }, "s600"), t = H("FITTING_REDUCER_LEFT", Z(), {
			inletWidth: 600,
			outletWidth: 300
		}, "red"), n = H("TRAY_STRAIGHT", Z(), { width: 300 }, "s300"), r = G.validateConnection(e, "PORT_B", t, "PORT_A"), i = G.validateConnection(t, "PORT_B", n, "PORT_A");
	...
	static testCaseF() {
		let e = z.get("TRAY_STRAIGHT"), t = new s("instA", e, { length: 3e3 }), n = new s("instB", e, { length: 3e3 }), r = U.computeMateTransform(t, "PORT_B", n, "PORT_A");
	...
	static testCaseG() {
		let e = z.get("TRAY_STRAIGHT"), t = [], n = new s("tray_0", e, { length: 3e3 });
		n.setPlacement({
			position: [
				0,
				0,
		...
		for (let n = 1; n < 10; n++) {
			...
			r.setPlacement(U.computePlacement(t[n - 1], "PORT_B", r, "PORT_A")), t.push(r);
		}
	...
	static testCaseH() {
		let e = st.exportDefinition(z.get("FITTING_ELBOW_90"));
	...
	static testCaseI() {
		let e = [
			...
			2,
			3
		].map((e) => H("FITTING_ELBOW_90", Z(), {}, `e${e}`));
		for (let t = 1; t < 4; t++) e[t].setPlacement(U.computePlacement(e[t - 1], "PORT_B", e[t], "PORT_A"));
	...
	static testCaseJ() {
		let e = z.get("OBSTACLE_MAIN_PROCESS_PIPE").getBounds({
			diameterMm: 500,
			lengthMm: 6e3,
			clearanceMm: 150
	...
	static testCaseK() {
		let e = Re.checkConformance({ width: 600 }), t = Re.checkConformance({ width: 550 });
	...
	static testCaseL() {
		let e = z.get("TRAY_STRAIGHT").getCenterlineRoutes({ length: 3e3 })[0], t = z.get("FITTING_ELBOW_90").getCenterlineRoutes({
			radius: 300,
			width: 600,
			angleDeg: 90,
			tangentLength: 0
		})[0], n = z.get("FITTING_ELBOW_45").getCenterlineRoutes({
			radius: 300,
			width: 600,
			angleDeg: 45,
			tangentLength: 0
		})[0], r = z.get("FITTING_ELBOW_90").getCenterlineRoutes({
			radius: 300,
			width: 600,
			tangentLength: 125
		})[0], i = [
			...
			Math.abs(r.analyticLength - W.arcWithTangents(600, 90, 125))
		], a = 0;
	...
	static testCaseM() {
		let e = new s("bay_01", z.get("STRUCT_MAIN_BAY")), t = z.get("STRUCT_COLUMN"), n = [
			e,
			new s("bay_01_col1", t, {}, {}, "bay_01"),
			new s("bay_01_col2", t, {}, {}, "bay_01"),
			new s("separate_col_01", t)
		], r = at.generateBom(n, { filterBundledChildren: !0 }), i = at.generateBom(n, { filterBundledChildren: !1 }), a = r.items.some((e) => e.definitionId === "STRUCT_MAIN_BAY" && e.isAssemblyKit), o = r.items.find((e) => e.definitionId === "STRUCT_COLUMN"), c = i.items.find((e) => e.definitionId === "STRUCT_COLUMN"), l = r.excludedBundledItems.includes("bay_01_col1") && r.excludedBundledItems.includes("bay_01_col2"), u = H("FITTING_ELBOW_90", Z(), { radius: 300 }, "eA"), d = H("FITTING_ELBOW_90", Z(), { radius: 600 }, "eB"), f = H("FITTING_ELBOW_90", Z(), { radius: 600 }, "eC"), p = at.generateBom([
			u,
			d,
			f
	...
	static testCaseP() {
		let t = new s("inst_consistency", z.get("FITTING_ELBOW_90"), {
			radius: 300,
			angleDeg: 45,
			width: 600,
			tangentLength: 0
	...
	static testCaseQ_CenterlinePortEndpoints() {
		let e = 0, t = 0, n = [];
		return z.getAll().forEach((r) => {
			(Ge(r.id) === "OTHER" ? [{
				label: "DEFAULT",
				params: r.defaultParameters
			}] : Ut(r)).forEach(({ label: i, params: a }) => {
	...
	static testCaseR_BoundsConsistency() {
		...
		return Ht().forEach((e) => Ut(e).forEach((t) => r(e.id, t.label, e, t.params))), [
			"STRUCT_COLUMN",
			"STRUCT_PIER",
			"STRUCT_MAIN_BAY",
			"STRUCT_BRANCH_BAY"
	...
	static testCaseS_PortFrameHandedness() {
		...
		return z.getAll().forEach((n) => {
			n.getLocalPorts(n.defaultParameters).forEach((r) => {
				e++;
				let i = new Ze(r.localPosition, r.localDirection, r.localUp).getDeterminant();
	...
	static testCaseT_EccentricReducerLength() {
		let e = z.get("FITTING_REDUCER_LEFT"), t = z.get("FITTING_REDUCER_CENTER"), n = e.getCenterlineRoutes({
			inletWidth: 600,
			outletWidth: 450,
			length: 500,
			tangentLength: 0
			...
			Math.abs(i.analyticLength - W.reducerWithTangents(600, 150, 200, 200)),
	...
	static testCaseU_TeePhysicalCenterline() {
		let e = z.get("FITTING_TEE").getCenterlineRoutes({
			width: 600,
			radius: 300,
			tangentLength: 125,
			depth: 150
		}).find((e) => e.id === "ROUTE_A_C"), t = W.teeBranch(1450, 725, 600), n = e.samplePoints.filter((e) => e[0] > -599.999999 && e[2] < 599.999999), r = n.reduce((e, t) => Math.max(e, Math.abs(Math.hypot(t[0] - -600, t[2] - 600) - 600)), 0), i = 0;
	...
	static testCaseV_DerivedStateExport() {
		let e = H("TRAY_STRAIGHT", Z(), {}, "test_export_inst"), t = st.exportScene([e]).instances[0];
	...
	static testCaseW_CatalogProfileA() {
		...
		e.components.forEach((n) => {
			let r = H(n.definitionId, e, {}, `a_${n.definitionId}`), i = r.effectiveParameters;
			(i.width !== 100 || i.depth !== 50 || i.trayStyle !== "VENTILATED_THROUGH") && t.push(`${n.definitionId} params`), Ge(n.definitionId) !== "STRAIGHT" && (i.radius !== 300 || i.tangentLength !== 125) && t.push(`${n.definitionId} R/T`), r.getWorldPorts().forEach((e) => {
	...
	static testCaseZ_CatalogAngles() {
		...
		return [
			...
			let n = t * Math.PI / 180, r = H(`FITTING_ELBOW_${t}`, Z(), {}, `h${t}`), i = r.getWorldPorts().find((e) => e.id === "PORT_B"), a = [
			...
			let o = H(`FITTING_RISER_IN_${t}`, Z(), {}, `vi${t}`).getWorldPorts().find((e) => e.id === "PORT_B"), s = [
			...
			let c = H(`FITTING_RISER_OUT_${t}`, Z(), {}, `vo${t}`).getWorldPorts().find((e) => e.id === "PORT_B"), l = [
				375 * Math.sin(n) + 125 * Math.cos(n),
				375 * Math.cos(n) - 125 * Math.sin(n),
				0
			];
	...
	static testCaseAA_VendorDimensionFormulas() {
		...
		Z().allowedWidths.forEach((t) => {
			let n = H("TRAY_STRAIGHT", Z(), { width: t }, `w${t}`).getBounds();
			Math.abs(n.max[0] - n.min[0] - (t + 26)) > 1e-6 && e.push(`ladder W${t} overall ${n.max[0] - n.min[0]}`);
		}), [Pt(), Ft()].forEach((t) => {
			let n = H("TRAY_STRAIGHT", t, {}, `v${t.id}`).getBounds();
			...
			let n = z.get("FITTING_TEE").getEngineeringDimensions(V("FITTING_TEE", Z(), { radius: t }));
			(n.mainSpan !== 600 + 2 * t + 250 || n.branchFromBackRail !== 600 + t + 125) && e.push(`tee R${t}`), z.get("FITTING_CROSS").getEngineeringDimensions(V("FITTING_CROSS", Z(), { radius: t })).span !== 600 + 2 * t + 250 && e.push(`cross R${t}`);
		});
		let t = z.get("FITTING_REDUCER_CENTER").getEngineeringDimensions(V("FITTING_REDUCER_CENTER", Z()));
		(t.length !== 600 || t.tangentLength !== 200 || t.transitionLength !== 200) && e.push("reducer stages");
		let n = pe(V("TRAY_STRAIGHT", Z())).rungs.map((e) => e.position[2] + 1500);
	...
	static testCaseAB_ProfileCatalogIntegrity() {
		...
		return i(t.height, 150, "ladder H"), i(t.allowedWidths, [
			...
			[30, 90],
			[90]
		], "vent B"), B.getAll().forEach((t) => {
			t.components.forEach((n) => {
				z.get(n.definitionId) || e.push(`${t.id}: unknown ${n.definitionId}`), n.pages.forEach((r) => {
	...
	static testCaseAC_GoldenFixtures() {
		let e = [];
		return Nt.forEach((t) => {
			let n = B.get(t.profileId), r = H(t.definitionId, n, t.params, `fx_${t.id}`), i = r.getWorldPorts();
			...
			if (Object.entries(t.expectedRouteLengths).forEach(([n, r]) => {
				...
				let n = It(r.getBounds(), t.expectedBounds), i = It(ot(r.definition, r.effectiveParameters), t.expectedBounds);
				(n > .01 || i > .05) && e.push({
					fx: t.id,
					boundsErr: n,
					geometryErr: i,
	...
	static testCaseAE_CrossCurvedCorners() {
		...
		return [
			...
			let a = Lt(new s("x", z.get("FITTING_CROSS"), {
				width: t,
				radius: n,
				depth: 150,
				tangentLength: 125,
	...
	static testCaseAF_ProfilePropagation() {
		...
		B.getAll().forEach((t) => {
			t.components.forEach((n) => {
				let r = H(n.definitionId, t, {}, `pp_${t.id}_${n.definitionId}`), i = r.getBounds();
				Math.abs(i.min[1] + t.height / 2) > 1e-6 && Ge(n.definitionId) !== "V_BEND" && e.push(`${t.id}/${n.definitionId}: height ${i.max[1] - i.min[1]}`), r.getWorldPorts().forEach((r) => {
				...
				let a = Xe(n.definitionId), o = t.trayType === "LADDER" ? "SYSTEM_LADDER" : t.width === 100 ? "SYSTEM_VENTILATED_SMALL" : "SYSTEM_VENTILATED_LARGE";
		...
		let t = H("FITTING_RISER_IN_90", Z(), {}, "vi_h"), n = t.definition.getEngineeringDimensions(t.effectiveParameters);
	...
	static testCaseAG_RadiusSemantics() {
		...
		let l = o(H("FITTING_RISER_OUT_90", Z(), {
			radius: 300,
			tangentLength: 0
		}, "vo"));
		...
		let d = new s("legacy", z.get("FITTING_ELBOW_90"), {
			width: 600,
			radius: 600,
		...
		let f = new s("legacyV", z.get("FITTING_RISER_OUT_90"), {
			depth: 100,
			radius: 600,
			radiusReference: "CENTERLINE",
			tangentLength: 0
	...
	static testCaseAH_ConnectionFaceTermination() {
		let e = [], t = 0;
		Ht().forEach((n) => {
			Ut(n).forEach(({ label: r, params: i }) => {
				[i, {
					...i,
					tangentLength: 0
				}].forEach((i) => {
					let a = new s(`t_${n.id}`, n, i), o = 0;
					if (Ge(n.id) === "REDUCER" && Number(i.tangentLength) === 0) {
					...
					K.checkPortTermination(a).forEach((a) => {
		...
		let n = new s("sp", z.get("TRAY_STRAIGHT"), { hasSplicePlates: !0 });
		return K.checkPortTermination(n).every((e) => e.passed) || e.push({
			id: "TRAY_STRAIGHT",
			label: "splice plates",
	...
	static testCaseAI_AssemblyRegression() {
		...
		return e.forEach((e) => {
			[300, 600].forEach((a) => {
				let o = rt(e.steps.map((e) => i(e, a)), { profile: Z() });
	...
	static testCaseAJ_NegativeControls() {
		let e = [], t = z.get("TRAY_STRAIGHT"), n = () => H("TRAY_STRAIGHT", Z(), {}, "nc_a"), r = {
			...t,
			id: "NC_OVERHANG",
		...
		{
			let t = n(), i = new s("nc_b", r, V("TRAY_STRAIGHT", Z()));
			U.placeComponentByPort(t, "PORT_B", i, "PORT_A");
			let a = K.checkJoint(t, "PORT_B", i, "PORT_A");
		...
		[{
			...
			let a = n(), o = H("TRAY_STRAIGHT", Z(), {}, "nc_b"), s = U.computePlacement(a, "PORT_B", o, "PORT_A");
			o.setPlacement({
				...s,
				position: [
					s.position[0],
			...
			let c = K.checkJoint(a, "PORT_B", o, "PORT_A");
			(c.passed || Math.abs(c.planeOffsetBMm - r) > .05) && e.push(`${i} not detected (${c.planeOffsetBMm})`);
		});
		{
			let t = n(), r = H("FITTING_RISER_IN_90", Z(), {}, "nc_r"), i = U.computePlacement(t, "PORT_B", r, "PORT_A"), a = t.getWorldPorts().find((e) => e.id === "PORT_B").worldPosition, s = o.fromAxisAngle([
				0,
				0,
				1
			...
			let u = K.checkJoint(t, "PORT_B", r, "PORT_A");
			(u.passed || u.upDot > .5 || u.faceMismatchMm < 10) && e.push(`rotation not detected (up ${u.upDot}, face ${u.faceMismatchMm})`);
		}
		{
			let t = n(), r = H("TRAY_STRAIGHT", Z(), { width: 300 }, "nc_w");
			U.placeComponentByPort(t, "PORT_B", r, "PORT_A");
			let i = K.checkJoint(t, "PORT_B", r, "PORT_A");
	...
	static testCaseAL_PlanFrameHandedness() {
		let t = [], n = ct.PAGE_Y_DOWN_METRES, r = ct.NORTH_UP_METRES, i = (e, t) => e.getWorldPorts().find((e) => e.id === t);
		for (let e of [n, r]) {
			let n = {
				x: 12.5,
				y: -3.25,
		...
		let a = (e) => {
			let t = e.toWorld({
				...
				y: 0,
				z: 0
			}), n = ut(l.normalize(l.sub(e.toWorld({
				x: 1,
				y: 0,
				z: 0
			}), t)));
		...
		let o = (t) => {
			let n = H("FITTING_REDUCER_LEFT", Z(), {
				inletWidth: 600,
				outletWidth: 300
	...
	static testCaseAM_NetworkFittings() {
		...
		for (let t = 0; t < o.length; t++) for (let n = t + 1; n < o.length; n++) for (let r of o[t].getWorldPorts()) for (let i of o[n].getWorldPorts()) {
			...
			let a = K.checkJoint(o[t], r.id, o[n], i.id);
	...
	static testCaseAN_NetworkNormalizeAndIssues() {
		let e = [], t = ct.PAGE_Y_DOWN_METRES, n = (e) => e.issues.filter((e) => e.severity === "ERROR").map((e) => e.code), r = kt(zt(), Z()), i = r.changes.find((e) => e.kind === "SEGMENT_WIDTH");
		...
		let s = Et(r.network, Z()), c = At(["s1", "vt"], r), l = At([
			"vt",
			"s1b",
			"s2"
		], r);
	...
	static testCaseAO_NetworkCenterline() {
		...
		let s = (e) => t.straights.find((t) => t.segmentId === e).instance, c = (e, n) => t.segmentEnds[`${e}@${n}`].fitting, l = new Map(t.fittings.map((e) => [e.id, e.instance])), u = (e, n) => l.get(t.segmentEnds[`${e}@${n}`].reducer.id), d = (e, t, n) => Vt(l.get(c(e, n).id), c(e, n).portId, c(t, n).portId), f = [
			Vt(s("s1"), "PORT_A", "PORT_B"),
			d("s1", "s1b", "VT"),
			Vt(s("s1b"), "PORT_A", "PORT_B"),
			d("s1b", "br", "T"),
			Vt(u("br", "T"), "PORT_A", "PORT_B"),
			Vt(s("br"), "PORT_A", "PORT_B"),
			d("br", "rs", "B"),
			Vt(s("rs"), "PORT_A", "PORT_B")
		], p = 0, m = 0;
		f.forEach((e, t) => {
		...
		let v = Et(dt([
			...
			to: "c",
			width: 600
		}], ct.PAGE_Y_DOWN_METRES), Z()).pathCenterline(["x", "y"]), y = v.polylineMm - v.lengthMm;
	...
	static testCaseAQ_HostMaterials() {
		let t = [], n = H("FITTING_TEE", Z(), {}, "aq_tee"), r = new e.MeshStandardMaterial({ color: 16711680 }), i = c.Tray.color.getHex(), a = n.getThreeMesh({ materials: { body: r } }), o = n.getThreeMesh(), s = (e) => {
			let t = [];
			return e.traverse((e) => {
				e.isMesh && t.push(e);
			}), t;
...
//#endregion
export { it as ASSEMBLY_DEMOS, Wt as AcceptanceTestSuite, W as AnalyticLength, ze as AssemblyRegistry, K as AssemblyValidator, t as AssumptionLevel, at as BomManager, n as BomScope, T as BoundsAccumulator, Re as CatalogStandards, s as ComponentInstance, r as ComponentOrigin, z as ComponentRegistry, i as ComponentRole, G as ConnectionValidator, I as GeometryGenerators, st as JsonExporter, E as LADDER_SECTION_CONSTANTS, jt as LEGACY_FITTING_BASELINES, U as MateEngine, c as Materials, ct as PlanFrames, Qe as RouteGenerator, Ye as SUB_CATEGORY_NAMES, qe as TRAY_SYSTEM_METAS, o as Transforms, B as TraySystemProfiles, a as Units, We as VENDOR_PROFILES, D as VENTILATED_SECTION_CONSTANTS, Gt as VERSION, lt as WORLD_UP, h as advanceFrame, m as arcCenter, rt as buildMatedAssembly, F as buildTrayLayoutGroup, ot as computeGeometryBounds, H as createComponentFromProfile, Se as crossLayout, re as faceOf, C as frameAtLength, Je as getComponentSubCategory, Xe as getComponentSystemCategories, me as horizontalBendLayout, ut as leftOfTravel, kt as normalizeTrayNetwork, ne as normalizeTrayStyle, g as pathEndFrame, _ as pathLength, Be as printedPageOf, Ce as reducerLayout, V as resolveProfileParameters, Et as resolveTrayNetwork, j as resolveTraySection, ue as rungCorners, S as samplePath, w as sectionPoint, d as sideOf, pe as straightLayout, xe as teeLayout, Ge as trayFamilyOf, dt as trayNetworkFromPlan, At as updateRouteForChanges, l as vec, he as verticalBendLayout };
