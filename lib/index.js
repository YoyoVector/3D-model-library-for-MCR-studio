...
function k(e, t) {
	let n = ie(e.trayStyle), r = t ?? O(e.width, 600), i = O(e.depth, 100), a = i / 2;
	if (n === "VENTILATED_THROUGH") {
		let t = D.sheetThickness, o = O(e.lipWidth, i >= 100 ? D.lipLarge : D.lipSmall);
		return {
			style: n,
			width: r,
			height: i,
	...
	return {
		...
		rung: {
			...
			spacing: O(e.rungSpacing, o.rungPitch)
		},
		innerInset: -s[0],
...
function pe(e) {
	let t = k(e), n = t.width, r = O(e.length, 3e3), i = {
		start: {
			position: [
				0,
				0,
	...
	if (e.hasDivider) {
		let n = t.rung ? t.rung.up[1] : t.floor.up[1], r = Math.max(1, Math.min(O(e.dividerHeight, 80), t.height / 2 - n));
		a.push({
			path: i,
			rects: [{
				side: [-2, 2],
	...
	if (t.rung) {
		...
		for (let n = s; n <= r - a - .5 + 1e-9; n += e) o.push(N(C(i, n), [-c, c], t));
	}
	let s = e.hasSplicePlates === !0 ? de(i, t, r) : [], c = [A("PORT_A", "Inlet Port A", i.start, !0, n, t), A("PORT_B", "Outlet Port B", g(i), !1, n, t)], l = [j("ROUTE_PORT_A_PORT_B", "PORT_A", "PORT_B", i, "STRAIGHT")];
...
function me(e, t) {
	let n = k(e), r = n.width, i = re(e, r / 2), a = te(e.tangentLength, 0), o = ne(e.angleDeg, t), s = o * Math.PI / 180, c = i + r / 2, l = {
		start: {
			position: [
				c,
				0,
	...
	if (n.rung) {
		...
		se(t, d - t, n.rung.spacing).forEach((t) => f.push(N(C(l, t), [-e, e], n)));
	}
	let p = [A("PORT_A", "Inlet Port A", l.start, !0, r, n), A("PORT_B", "Outlet Port B", g(l), !1, r, n)], m = [j("ROUTE_PORT_A_PORT_B", "PORT_A", "PORT_B", l, "ARC_XZ")];
...
function he(e, t, n) {
	let r = k(e), i = r.width, a = r.height, o = re(e, a / 2), s = te(e.tangentLength, 0), c = ne(e.angleDeg, t), l = c * Math.PI / 180, u = o + a / 2, d = {
		start: {
			position: [
				-s,
				n ? u : -u,
	...
	if (r.rung) {
		...
		se(a, p - a, r.rung.spacing).forEach((t) => m.push(N(C(d, t), [-e, e], r)));
	}
	let h = [A("PORT_A", n ? "Upper Horizontal Inlet" : "Lower Horizontal Inlet", d.start, !0, i, r), A("PORT_B", n ? "Lower Outlet" : "Upper Outlet", g(d), !1, i, r)], v = [j("ROUTE_PORT_A_PORT_B", "PORT_A", "PORT_B", d, "ARC_XY")];
...
function xe(e) {
	let t = k(e), n = t.width, r = re(e, n / 2), i = te(e.tangentLength, 125), a = be(e.length, n, r, i, !0), o = be(e.branchLength, n, r, i, !1), s = n / 2 + r + a, c = n / 2 + r + o, l = r + n / 2, u = {
		start: {
			position: [
				-s,
				0,
	...
	if (t.rung) {
		...
		if (se(-(s - l), s - l, t.rung.spacing).forEach((a) => {
			...
			se(n / 2 + r + e, c - e, t.rung.spacing).forEach((e) => h.push(N({
				position: [
					0,
					0,
					e
	...
	let v = {
		...
		A("PORT_A", "Main Run Inlet Port A", v.start, !0, n, t),
		A("PORT_B", "Main Run Outlet Port B", g(v), !1, n, t),
		A("PORT_C", "Branch Outlet Port C", g(y), !1, n, t)
	], S = [
		j("ROUTE_A_B", "PORT_A", "PORT_B", v, "STRAIGHT"),
		j("ROUTE_A_C", "PORT_A", "PORT_C", y, "ARC_XZ"),
		j("ROUTE_B_C", "PORT_B", "PORT_C", b, "ARC_XZ")
	];
	return fe("TEE", t, {
		style: t.style,
		width: n,
...
function Se(e) {
	let t = k(e), n = t.width, r = re(e, n / 2), i = te(e.tangentLength, 125), a = be(e.length, n, r, i, !0), o = n / 2 + r + a, s = r + n / 2, c = [
		[1, 1],
		[-1, 1],
		[-1, -1],
		[1, -1]
	...
	if (t.rung) {
		...
		if (se(-(o - s), o - s, t.rung.spacing).forEach((a) => {
			...
			let e = n / 2 - i;
			[1, -1].forEach((i) => se(n / 2 + r + s, o - s, t.rung.spacing).forEach((n) => d.push(N({
				position: [
					0,
					0,
					i * n
	...
	let f = {
		...
		A("PORT_A", "Inlet Port A (-X)", f.start, !0, n, t),
		A("PORT_B", "Outlet Port B (+X)", g(f), !1, n, t),
		A("PORT_C", "Branch Port C (+Z)", g(p), !1, n, t),
		A("PORT_D", "Branch Port D (-Z)", p.start, !0, n, t)
	], h = {
		[-1]: "PORT_A",
		1: "PORT_B"
	}, v = {
		...
		j("ROUTE_PORT_A_PORT_B", "PORT_A", "PORT_B", f, "STRAIGHT"),
		j("ROUTE_PORT_D_PORT_C", "PORT_D", "PORT_C", p, "STRAIGHT"),
		...[
			[-1, 1],
			[-1, -1],
			[1, 1],
			[1, -1]
		].map(([e, t]) => j(`ROUTE_${h[e]}_${v[t]}`, h[e], v[t], _e(n, r, o, o, e, t), "ARC_XZ"))
	];
	return fe("CROSS", t, {
		style: t.style,
		width: n,
...
function Ce(e, t) {
	let n = O(e.inletWidth, 600), r = O(e.outletWidth, 450), i = k(e, n), a = O(e.length, 500), o = Math.min(te(e.tangentLength, 0), Math.max(0, (a - 1) / 2)), s = a - 2 * o, c = r / 2, l = -r / 2;
	...
	let C = k(e, n), w = k(e, r), T = [A("PORT_A", "Wide Inlet Port A", v.start, !0, n, C), A("PORT_B", "Narrow Outlet Port B", g(v), !1, r, w)], E = [j("ROUTE_PORT_A_PORT_B", "PORT_A", "PORT_B", v, "STRAIGHT")];
	return fe("REDUCER", i, {
		style: i.style,
		reducerType: t,
		inletWidth: n,
...
function F(t, n = {}) {
	...
	let i = n.isIS ? c.TrayIS : c.Tray, a = (t, n, i, a, o = !1) => {
		if (t.isEmpty) return;
		let s = new e.Mesh(t.toGeometry(), a);
		s.name = n, s.castShadow = !0, s.receiveShadow = !0, s.userData = {
			part: i,
			isAccessory: o
		}, r.add(s);
	}, o = new we();
	Te(o, t.sweeps.filter((e) => e.part === "RAIL")), a(o, "Rails", "RAILS", i);
	let s = new we();
	Te(s, t.sweeps.filter((e) => e.part === "FLOOR")), t.floors.forEach((e) => s.addFloor(e)), a(s, "Floor", "FLOOR", i);
	let l = new we();
	t.rungs.forEach((e) => l.addBox(e)), a(l, "Rungs", "RUNGS", i);
	let u = new we();
	Te(u, t.sweeps.filter((e) => e.part === "DIVIDER")), a(u, "Divider", "DIVIDER", c.Divider);
	let d = new we();
	return Te(d, t.accessories), a(d, "SplicePlates", "ACCESSORY", c.Support, !0), r;
}
//#endregion
...
var B = class {
	...
	static initAll() {
		this._definitions.clear(), this.register(je()), this.register(Me()), this.register({
			schemaVersion: "2.0.0",
		...
		}), this.register(Ne("FITTING_ELBOW_90", 90, r.LEGACY_FITTING_LIBRARY, "PDF p.5 / p.31 / p.42")), this.register(Pe()), this.register(z("FITTING_RISER_IN_90", 90, !1, r.LEGACY_FITTING_LIBRARY, "PDF p.11 / p.34 / p.44")), this.register(z("FITTING_RISER_OUT_90", 90, !0, r.LEGACY_FITTING_LIBRARY, "PDF p.15 / p.35 / p.45")), this.register({
			schemaVersion: "2.0.0",
			componentVersion: "1.0.0",
		...
		}), this.register(Ne("FITTING_ELBOW_45", 45, r.NEW_COMPONENT, "PDF p.7 / p.32")), this.register(Ne("FITTING_ELBOW_60", 60, r.NEW_COMPONENT, "PDF p.6")), this.register(Ne("FITTING_ELBOW_30", 30, r.NEW_COMPONENT, "PDF p.8 / p.43")), this.register(z("FITTING_RISER_IN_45", 45, !1, r.NEW_COMPONENT, "PDF p.13")), this.register(z("FITTING_RISER_IN_60", 60, !1, r.NEW_COMPONENT, "PDF p.12")), this.register(z("FITTING_RISER_IN_30", 30, !1, r.NEW_COMPONENT, "PDF p.14")), this.register(z("FITTING_RISER_OUT_45", 45, !0, r.NEW_COMPONENT, "PDF p.17")), this.register(z("FITTING_RISER_OUT_60", 60, !0, r.NEW_COMPONENT, "PDF p.16")), this.register(z("FITTING_RISER_OUT_30", 30, !0, r.NEW_COMPONENT, "PDF p.18")), this.register(Ie("FITTING_REDUCER_LEFT", "LEFT", {
			name: "Left Reducer",
			nameZh: "左偏異徑接頭",
			page: "PDF p.20"
		})), this.register(Ie("FITTING_REDUCER_CENTER", "CONCENTRIC", {
			name: "Center Reducer",
			nameZh: "中間異徑接頭",
			page: "PDF p.19"
		})), this.register(Ie("FITTING_REDUCER_RIGHT", "RIGHT", {
			name: "Right Reducer",
			nameZh: "右偏異徑接頭",
			page: "PDF p.21"
		})), this.register(Fe()), this.register({
			schemaVersion: "2.0.0",
			componentVersion: "1.0.0",
			id: "STRUCT_MAIN_BAY",
...
var Be = "R = inner radius of the bend (inner side rail for horizontal bends / tee / cross; rail-top side for vertical inside bends; tray bottom for vertical outside bends). Routing centerline radius = R + W/2 (horizontal) or R + H/2 (vertical).", Ve = [
	100,
	200,
	300,
	400,
	...
	900,
	1e3
], He = "Polyester powder coating #67 light grey, ≥ 50 µm", Ue = {
...
function H(e, t, n = {}) {
	...
	switch (t.lipWidthMm && (r.lipWidth = t.lipWidthMm), We(e)) {
		case "STRAIGHT":
		...
		case "REDUCER": {
			...
			r.inletWidth = e, r.outletWidth = Ge(t, e), r.length = t.reducerLength || 600, r.tangentLength = t.reducerTangentLength || 200;
			break;
		}
	}
	return {
...
function U(e, t, n = {}, r) {
	...
	return new s(r || `${e.toLowerCase()}_${Date.now()}_${Math.floor(Math.random() * 1e3)}`, i, H(e, t, n));
}
//#endregion
...
function Ye(e) {
	...
	let t = [];
	return Object.values(Ke).forEach((n) => {
		let r = n.profileId ? Ue[n.profileId] : void 0;
...
var Xe = class {
	...
	static computeMateTransform(t, n, r, i, a = .5) {
		...
		let c = new Xe(o.worldPosition, o.worldDirection, o.worldUp), l = c.direction.clone().negate().normalize(), u = c.up.clone().normalize(), d = new e.Vector3().crossVectors(u, l).normalize(), f = new e.Vector3().crossVectors(l, d).normalize(), p = new e.Matrix4();
		p.makeBasis(d, f, l);
		let m = new Xe(s.localPosition, s.localDirection, s.localUp), h = new e.Matrix4();
		...
		}, S = m.position.clone().applyQuaternion(v).add(b), C = m.direction.clone().applyQuaternion(v).normalize(), w = m.up.clone().applyQuaternion(v).normalize(), T = S.distanceTo(c.position), E = C.dot(c.direction), D = w.dot(c.up), ee = T <= a && E <= -.99 && D >= .99;
		return {
			success: ee,
			placement: x,
			positionErrorMm: T,
			...
			upDotProduct: D,
			message: ee ? `Mated successfully. Position error: ${T.toFixed(4)} mm, alignment dot: ${E.toFixed(4)}` : `Mating out of tolerance. Error: ${T.toFixed(4)} mm, dot: ${E.toFixed(4)}`
		};
	}
	...
	static createHorizontalElbow(e, t, n, r, i = 20, a = 0) {
		...
		return {
			...
			toPort: t,
			type: "ARC_XZ",
			analyticLength: a > 0 ? G.arcWithTangents(n, r, a) : G.circularArc(n, r),
			samplePoints: s
		};
	}
	...
	static createVerticalRiser(e, t, n, r, i = !1, a = 20) {
		...
		return {
			...
			toPort: t,
			type: "ARC_XY",
			analyticLength: G.circularArc(n, r),
			samplePoints: s
		};
	}
...
var q = class {
	static checkJoint(e, t, n, r, i = {}) {
		let a = i.positionMm ?? .01, s = i.planeMm ?? .05, c = i.faceMm ?? .05, l = i.dot ?? 1e-6, u = [], d = K.validateConnection(e, t, n, r), f = e.getWorldPorts().find((e) => e.id === t), p = n.getWorldPorts().find((e) => e.id === r), m = {
		...
		if (!f || !p) return m;
		let h = $e(f), g = $e(p), _ = h.origin.distanceTo(g.origin), v = h.normal.dot(g.normal), y = h.up.dot(g.up), b = et(Qe(e), h, h, s, 1), x = et(Qe(n), h, h, s, -1), S = 0, C = f.connectionFace, w = (e, t) => {
			if (!e) {
		...
		let T = tt(e, t), E = tt(n, r), D = T && E ? o.distance(T, E) : Infinity;
	...
	static checkPortTermination(e, t = {}) {
		let n = t.planeMm ?? .05, r = t.faceMm ?? .05, i = Qe(e);
		return e.getWorldPorts().filter((e) => e.connectionType === "TRAY_END").map((e) => {
			let t = $e(e), a = et(i, t, t, n), o = Infinity;
...
function nt(e, t = {}) {
	...
	return e.forEach((e, a) => {
		let o = B.get(e.definitionId);
		if (!o) throw Error(`Unknown component '${e.definitionId}'`);
		let c = t.profile ? H(e.definitionId, t.profile, e.overrides ?? {}) : { ...e.overrides ?? {} }, l = new s(e.instanceId ?? `asm_${a}_${e.definitionId.toLowerCase()}`, o, c);
		if (a === 0) {
			t.basePlacement && l.setPlacement(t.basePlacement), n.push(l);
			return;
		}
		let u = e.attachTo ?? a - 1, d = n[u], f = e.attachPort ?? "PORT_B", p = e.port ?? "PORT_A", m = W.placeComponentByPort(d, f, l, p);
		m.success || i.push(`Step ${a} (${e.definitionId}): ${m.message}`), n.push(l);
		let h = q.checkJoint(d, f, l, p);
...
var rt = {
	...
	static generateBom(e, t = {}) {
		...
		e.forEach((e) => {
			(Re.isAssembly(e.definitionId) || e.definition.subComponents && e.definition.subComponents.length > 0) && (c.add(e.instanceId), (Re.getSubComponents(e.definitionId).length > 0 ? Re.getSubComponents(e.definitionId) : e.definition.subComponents || []).forEach((t) => {
		...
		e.forEach((e) => {
			...
			let g = Re.isAssembly(t.id) || t.subComponents && t.subComponents.length > 0 || !1, _ = `${t.id}|${f}`;
...
}, J = Math.SQRT1_2, Y = Math.sqrt(3) / 2, X = Math.PI / 2, ct = [
	{
...
], Z = () => V.get("LADDER_PROFILE_STANDARD"), lt = () => V.get("VENTILATED_PROFILE_A"), ut = () => V.get("VENTILATED_PROFILE_B");
function Q(e, t) {
	return Math.hypot(e[0] - t[0], e[1] - t[1], e[2] - t[2]);
}
function dt(e, t) {
...
function mt() {
	return B.getAll().filter((e) => We(e.id) !== "OTHER");
}
function ht(e) {
	let t = [{
		label: "GENERIC",
	...
	return V.getAll().forEach((n) => {
		V.supports(n, e.id) && t.push({
			label: n.id,
			params: {
				...e.defaultParameters,
				...H(e.id, n)
...
var gt = class {
	...
	static testCaseA() {
		let e = U("TRAY_STRAIGHT", Z(), {}, "inst_straight"), t = U("FITTING_ELBOW_90", Z(), {}, "inst_elbow"), n = K.validateConnection(e, "PORT_B", t, "PORT_A");
	...
	static testCaseB() {
		let e = new s("inst_straight", B.get("TRAY_STRAIGHT"), {
			width: 600,
			depth: 100
		}), t = new s("inst_elbow", B.get("FITTING_ELBOW_90"), {
			width: 450,
			depth: 100
		}), n = K.validateConnection(e, "PORT_B", t, "PORT_A");
	...
	static testCaseD() {
		let e = new s("inst_straight", B.get("TRAY_STRAIGHT")), t = new s("inst_jb", B.get("EQUIP_JUNCTION_BOX")), n = K.validateConnection(e, "PORT_B", t, "PORT_BOTTOM_GLAND"), r = new s("l", B.get("TRAY_STRAIGHT"), {
			width: 300,
			depth: 100,
			trayStyle: "LADDER"
		}), i = new s("v", B.get("FITTING_ELBOW_90"), {
			width: 300,
			depth: 100,
			trayStyle: "VENTILATED_THROUGH"
		}), a = K.validateConnection(r, "PORT_B", i, "PORT_A");
	...
	static testCaseE() {
		let e = U("TRAY_STRAIGHT", Z(), { width: 600 }, "s600"), t = U("FITTING_REDUCER_LEFT", Z(), {
			inletWidth: 600,
			outletWidth: 300
		}, "red"), n = U("TRAY_STRAIGHT", Z(), { width: 300 }, "s300"), r = K.validateConnection(e, "PORT_B", t, "PORT_A"), i = K.validateConnection(t, "PORT_B", n, "PORT_A");
	...
	static testCaseF() {
		let e = B.get("TRAY_STRAIGHT"), t = new s("instA", e, { length: 3e3 }), n = new s("instB", e, { length: 3e3 }), r = W.computeMateTransform(t, "PORT_B", n, "PORT_A");
	...
	static testCaseG() {
		let e = B.get("TRAY_STRAIGHT"), t = [], n = new s("tray_0", e, { length: 3e3 });
		n.setPlacement({
			position: [
				0,
				0,
		...
		for (let n = 1; n < 10; n++) {
			...
			r.setPlacement(W.computePlacement(t[n - 1], "PORT_B", r, "PORT_A")), t.push(r);
		}
	...
	static testCaseH() {
		let e = ot.exportDefinition(B.get("FITTING_ELBOW_90"));
	...
	static testCaseI() {
		let e = [
			...
			2,
			3
		].map((e) => U("FITTING_ELBOW_90", Z(), {}, `e${e}`));
		for (let t = 1; t < 4; t++) e[t].setPlacement(W.computePlacement(e[t - 1], "PORT_B", e[t], "PORT_A"));
	...
	static testCaseJ() {
		let e = B.get("OBSTACLE_MAIN_PROCESS_PIPE").getBounds({
			diameterMm: 500,
			lengthMm: 6e3,
			clearanceMm: 150
	...
	static testCaseK() {
		let e = Le.checkConformance({ width: 600 }), t = Le.checkConformance({ width: 550 });
	...
	static testCaseL() {
		let e = B.get("TRAY_STRAIGHT").getCenterlineRoutes({ length: 3e3 })[0], t = B.get("FITTING_ELBOW_90").getCenterlineRoutes({
			radius: 300,
			width: 600,
			angleDeg: 90,
			tangentLength: 0
		})[0], n = B.get("FITTING_ELBOW_45").getCenterlineRoutes({
			radius: 300,
			width: 600,
			angleDeg: 45,
			tangentLength: 0
		})[0], r = B.get("FITTING_ELBOW_90").getCenterlineRoutes({
			radius: 300,
			width: 600,
			tangentLength: 125
		})[0], i = [
			...
			Math.abs(r.analyticLength - G.arcWithTangents(600, 90, 125))
		], a = 0;
	...
	static testCaseM() {
		let e = new s("bay_01", B.get("STRUCT_MAIN_BAY")), t = B.get("STRUCT_COLUMN"), n = [
			e,
			new s("bay_01_col1", t, {}, {}, "bay_01"),
			new s("bay_01_col2", t, {}, {}, "bay_01"),
			new s("separate_col_01", t)
		], r = it.generateBom(n, { filterBundledChildren: !0 }), i = it.generateBom(n, { filterBundledChildren: !1 }), a = r.items.some((e) => e.definitionId === "STRUCT_MAIN_BAY" && e.isAssemblyKit), o = r.items.find((e) => e.definitionId === "STRUCT_COLUMN"), c = i.items.find((e) => e.definitionId === "STRUCT_COLUMN"), l = r.excludedBundledItems.includes("bay_01_col1") && r.excludedBundledItems.includes("bay_01_col2"), u = U("FITTING_ELBOW_90", Z(), { radius: 300 }, "eA"), d = U("FITTING_ELBOW_90", Z(), { radius: 600 }, "eB"), f = U("FITTING_ELBOW_90", Z(), { radius: 600 }, "eC"), p = it.generateBom([
			u,
			d,
			f
	...
	static testCaseN() {
		...
		let n = 0, r = [];
		return Object.keys(st).forEach((i) => {
			let a = st[i], o = B.get(i);
			if (!o) {
				n++, r.push({
					id: i,
	...
	static testCaseP() {
		let t = new s("inst_consistency", B.get("FITTING_ELBOW_90"), {
			radius: 300,
			angleDeg: 45,
			width: 600,
			tangentLength: 0
	...
	static testCaseQ_CenterlinePortEndpoints() {
		let e = 0, t = 0, n = [];
		return B.getAll().forEach((r) => {
			(We(r.id) === "OTHER" ? [{
				label: "DEFAULT",
				params: r.defaultParameters
			}] : ht(r)).forEach(({ label: i, params: a }) => {
	...
	static testCaseR_BoundsConsistency() {
		...
		return mt().forEach((e) => ht(e).forEach((t) => r(e.id, t.label, e, t.params))), [
			"STRUCT_COLUMN",
			"STRUCT_PIER",
			"STRUCT_MAIN_BAY",
			"STRUCT_BRANCH_BAY"
	...
	static testCaseS_PortFrameHandedness() {
		...
		return B.getAll().forEach((n) => {
			n.getLocalPorts(n.defaultParameters).forEach((r) => {
				e++;
				let i = new Xe(r.localPosition, r.localDirection, r.localUp).getDeterminant();
	...
	static testCaseT_EccentricReducerLength() {
		let e = B.get("FITTING_REDUCER_LEFT"), t = B.get("FITTING_REDUCER_CENTER"), n = e.getCenterlineRoutes({
			inletWidth: 600,
			outletWidth: 450,
			length: 500,
			tangentLength: 0
			...
			Math.abs(i.analyticLength - G.reducerWithTangents(600, 150, 200, 200)),
	...
	static testCaseU_TeePhysicalCenterline() {
		let e = B.get("FITTING_TEE").getCenterlineRoutes({
			width: 600,
			radius: 300,
			tangentLength: 125,
			depth: 150
		}).find((e) => e.id === "ROUTE_A_C"), t = G.teeBranch(1450, 725, 600), n = e.samplePoints.filter((e) => e[0] > -599.999999 && e[2] < 599.999999), r = n.reduce((e, t) => Math.max(e, Math.abs(Math.hypot(t[0] - -600, t[2] - 600) - 600)), 0), i = 0;
	...
	static testCaseV_DerivedStateExport() {
		let e = U("TRAY_STRAIGHT", Z(), {}, "test_export_inst"), t = ot.exportScene([e]).instances[0];
	...
	static testCaseW_CatalogProfileA() {
		...
		e.components.forEach((n) => {
			let r = U(n.definitionId, e, {}, `a_${n.definitionId}`), i = r.effectiveParameters;
			(i.width !== 100 || i.depth !== 50 || i.trayStyle !== "VENTILATED_THROUGH") && t.push(`${n.definitionId} params`), We(n.definitionId) !== "STRAIGHT" && (i.radius !== 300 || i.tangentLength !== 125) && t.push(`${n.definitionId} R/T`), r.getWorldPorts().forEach((e) => {
	...
	static testCaseY_HorizontalCross() {
		...
		return [300, 600].forEach((n) => {
			...
			let f = ft(i.getThreeMesh()), p = 300 + n;
			[
				[
					-1,
					1,
	...
	static testCaseZ_CatalogAngles() {
		...
		return [
			...
			let n = t * Math.PI / 180, r = U(`FITTING_ELBOW_${t}`, Z(), {}, `h${t}`), i = r.getWorldPorts().find((e) => e.id === "PORT_B"), a = [
			...
			let o = U(`FITTING_RISER_IN_${t}`, Z(), {}, `vi${t}`).getWorldPorts().find((e) => e.id === "PORT_B"), s = [
			...
			let c = U(`FITTING_RISER_OUT_${t}`, Z(), {}, `vo${t}`).getWorldPorts().find((e) => e.id === "PORT_B"), l = [
				375 * Math.sin(n) + 125 * Math.cos(n),
				375 * Math.cos(n) - 125 * Math.sin(n),
				0
			];
	...
	static testCaseAA_VendorDimensionFormulas() {
		...
		Z().allowedWidths.forEach((t) => {
			let n = U("TRAY_STRAIGHT", Z(), { width: t }, `w${t}`).getBounds();
			Math.abs(n.max[0] - n.min[0] - (t + 26)) > 1e-6 && e.push(`ladder W${t} overall ${n.max[0] - n.min[0]}`);
		}), [lt(), ut()].forEach((t) => {
			let n = U("TRAY_STRAIGHT", t, {}, `v${t.id}`).getBounds();
			...
			let n = B.get("FITTING_TEE").getEngineeringDimensions(H("FITTING_TEE", Z(), { radius: t }));
			(n.mainSpan !== 600 + 2 * t + 250 || n.branchFromBackRail !== 600 + t + 125) && e.push(`tee R${t}`), B.get("FITTING_CROSS").getEngineeringDimensions(H("FITTING_CROSS", Z(), { radius: t })).span !== 600 + 2 * t + 250 && e.push(`cross R${t}`);
		});
		let t = B.get("FITTING_REDUCER_CENTER").getEngineeringDimensions(H("FITTING_REDUCER_CENTER", Z()));
		(t.length !== 600 || t.tangentLength !== 200 || t.transitionLength !== 200) && e.push("reducer stages");
		let n = pe(H("TRAY_STRAIGHT", Z())).rungs.map((e) => e.position[2] + 1500);
	...
	static testCaseAB_ProfileCatalogIntegrity() {
		...
		return i(t.height, 150, "ladder H"), i(t.allowedWidths, [
			...
			[30, 90],
			[90]
		], "vent B"), V.getAll().forEach((t) => {
			t.components.forEach((n) => {
				B.get(n.definitionId) || e.push(`${t.id}: unknown ${n.definitionId}`), n.pages.forEach((r) => {
	...
	static testCaseAC_GoldenFixtures() {
		let e = [];
		return ct.forEach((t) => {
			let n = V.get(t.profileId), r = U(t.definitionId, n, t.params, `fx_${t.id}`), i = r.getWorldPorts();
			...
			if (Object.entries(t.expectedRouteLengths).forEach(([n, r]) => {
				...
				let n = dt(r.getBounds(), t.expectedBounds), i = dt(at(r.definition, r.effectiveParameters), t.expectedBounds);
				(n > .01 || i > .05) && e.push({
					fx: t.id,
					boundsErr: n,
					geometryErr: i,
		...
		}), $("Case AC", "型錄黃金樣本 (Vendor Catalog Golden Fixtures)", e.length === 0, `${ct.length} fixtures from PDF p.4–45: ports, directions, up vectors, route lengths, bounds (analytic & mesh), dimensions`, `PASS (${ct.length} 組型錄黃金樣本全數吻合)`, `${e.length} mismatches`, { failures: e });
	}
	static testCaseAD_TeeCurvedTransition() {
		...
		[
			...
			let a = ft(U("FITTING_TEE", e, {
				width: n,
				radius: r
			}, `tee_${n}_${r}`).getThreeMesh()), o = n / 2 + r, s = pt(a, [-o, o], r - i, 270, 90), c = pt(a, [o, o], r - i, 180, 90);
		...
		let i = pt(ft(n), [-600, 600], 287, 270, 90);
	...
	static testCaseAE_CrossCurvedCorners() {
		...
		return [
			...
			let a = ft(new s("x", B.get("FITTING_CROSS"), {
				width: t,
				radius: n,
				depth: 150,
				tangentLength: 125,
	...
	static testCaseAF_ProfilePropagation() {
		...
		V.getAll().forEach((t) => {
			t.components.forEach((n) => {
				let r = U(n.definitionId, t, {}, `pp_${t.id}_${n.definitionId}`), i = r.getBounds();
				Math.abs(i.min[1] + t.height / 2) > 1e-6 && We(n.definitionId) !== "V_BEND" && e.push(`${t.id}/${n.definitionId}: height ${i.max[1] - i.min[1]}`), r.getWorldPorts().forEach((r) => {
				...
				let a = Ye(n.definitionId), o = t.trayType === "LADDER" ? "SYSTEM_LADDER" : t.width === 100 ? "SYSTEM_VENTILATED_SMALL" : "SYSTEM_VENTILATED_LARGE";
		...
		let t = U("FITTING_RISER_IN_90", Z(), {}, "vi_h"), n = t.definition.getEngineeringDimensions(t.effectiveParameters);
	...
	static testCaseAG_RadiusSemantics() {
		let t = [], n = U("FITTING_ELBOW_90", Z(), {
			width: 600,
			radius: 600,
			tangentLength: 0
		}, "h"), r = ft(n.getThreeMesh()).map((e) => Math.hypot(e[0], e[2]));
		...
		let i = U("FITTING_RISER_IN_90", Z(), {
			radius: 300,
			tangentLength: 0
		}, "vi"), a = ft(i.getThreeMesh()).map((e) => Math.hypot(e[0], e[1]));
		(Math.abs(Math.min(...a) - 300) > .05 || Math.abs(Math.max(...a) - 450) > .05) && t.push(`VI radial ${Math.min(...a)}..${Math.max(...a)}`);
		let o = (t) => {
			let n = new e.Group();
			return n.add(t.getThreeMesh().getObjectByName("Rungs").clone()), ft(n).map((e) => Math.hypot(e[0], e[1]));
		}, c = o(i);
		Math.min(...c) < 400 && t.push(`VI rungs not on the outer (bottom) side: min r ${Math.min(...c)}`);
		let l = o(U("FITTING_RISER_OUT_90", Z(), {
			radius: 300,
			tangentLength: 0
		}, "vo"));
		...
		let d = new s("legacy", B.get("FITTING_ELBOW_90"), {
			width: 600,
			radius: 600,
		...
		let f = new s("legacyV", B.get("FITTING_RISER_OUT_90"), {
			depth: 100,
			radius: 600,
			radiusReference: "CENTERLINE",
			tangentLength: 0
	...
	static testCaseAH_ConnectionFaceTermination() {
		let e = [], t = 0;
		mt().forEach((n) => {
			ht(n).forEach(({ label: r, params: i }) => {
				[i, {
					...i,
					tangentLength: 0
				}].forEach((i) => {
					let a = new s(`t_${n.id}`, n, i), o = 0;
					if (We(n.id) === "REDUCER" && Number(i.tangentLength) === 0) {
					...
					q.checkPortTermination(a).forEach((a) => {
		...
		let n = new s("sp", B.get("TRAY_STRAIGHT"), { hasSplicePlates: !0 });
		return q.checkPortTermination(n).every((e) => e.passed) || e.push({
			id: "TRAY_STRAIGHT",
			label: "splice plates",
	...
	static testCaseAI_AssemblyRegression() {
		...
		return e.forEach((e) => {
			[300, 600].forEach((a) => {
				let o = nt(e.steps.map((e) => i(e, a)), { profile: Z() });
	...
	static testCaseAJ_NegativeControls() {
		let e = [], t = B.get("TRAY_STRAIGHT"), n = () => U("TRAY_STRAIGHT", Z(), {}, "nc_a"), r = {
			...t,
			id: "NC_OVERHANG",
		...
		{
			let t = n(), i = new s("nc_b", r, H("TRAY_STRAIGHT", Z()));
			W.placeComponentByPort(t, "PORT_B", i, "PORT_A");
			let a = q.checkJoint(t, "PORT_B", i, "PORT_A");
		...
		[{
			...
			let a = n(), o = U("TRAY_STRAIGHT", Z(), {}, "nc_b"), s = W.computePlacement(a, "PORT_B", o, "PORT_A");
			o.setPlacement({
				...s,
				position: [
					s.position[0],
			...
			let c = q.checkJoint(a, "PORT_B", o, "PORT_A");
			(c.passed || Math.abs(c.planeOffsetBMm - r) > .05) && e.push(`${i} not detected (${c.planeOffsetBMm})`);
		});
		{
			let t = n(), r = U("FITTING_RISER_IN_90", Z(), {}, "nc_r"), i = W.computePlacement(t, "PORT_B", r, "PORT_A"), a = t.getWorldPorts().find((e) => e.id === "PORT_B").worldPosition, s = o.fromAxisAngle([
				0,
				0,
				1
			...
			let u = q.checkJoint(t, "PORT_B", r, "PORT_A");
			(u.passed || u.upDot > .5 || u.faceMismatchMm < 10) && e.push(`rotation not detected (up ${u.upDot}, face ${u.faceMismatchMm})`);
		}
		{
			let t = n(), r = U("TRAY_STRAIGHT", Z(), { width: 300 }, "nc_w");
			W.placeComponentByPort(t, "PORT_B", r, "PORT_A");
			let i = q.checkJoint(t, "PORT_B", r, "PORT_A");
...
//#endregion
export { rt as ASSEMBLY_DEMOS, gt as AcceptanceTestSuite, G as AnalyticLength, Re as AssemblyRegistry, q as AssemblyValidator, t as AssumptionLevel, it as BomManager, n as BomScope, T as BoundsAccumulator, Le as CatalogStandards, s as ComponentInstance, r as ComponentOrigin, B as ComponentRegistry, i as ComponentRole, K as ConnectionValidator, I as GeometryGenerators, ot as JsonExporter, E as LADDER_SECTION_CONSTANTS, st as LEGACY_FITTING_BASELINES, W as MateEngine, c as Materials, Ze as RouteGenerator, Je as SUB_CATEGORY_NAMES, Ke as TRAY_SYSTEM_METAS, o as Transforms, V as TraySystemProfiles, a as Units, Ue as VENDOR_PROFILES, D as VENTILATED_SECTION_CONSTANTS, _t as VERSION, h as advanceFrame, m as arcCenter, nt as buildMatedAssembly, F as buildTrayLayoutGroup, at as computeGeometryBounds, U as createComponentFromProfile, Se as crossLayout, ae as faceOf, C as frameAtLength, qe as getComponentSubCategory, Ye as getComponentSystemCategories, me as horizontalBendLayout, ie as normalizeTrayStyle, g as pathEndFrame, _ as pathLength, ze as printedPageOf, Ce as reducerLayout, H as resolveProfileParameters, k as resolveTraySection, ue as rungCorners, S as samplePath, w as sectionPoint, d as sideOf, pe as straightLayout, xe as teeLayout, We as trayFamilyOf, l as vec, he as verticalBendLayout };
